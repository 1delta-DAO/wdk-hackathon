 ...
 */
export function buildMigration(params: MigrationParams): SettlementResult {
  ...
  return { orderData, executionData, fillerCalldata: '0x', merkleRoot: root }
}

// ═══════════════════════════════════════════════════════════
//  1b. Simple Migration (with APR check via MigrationSettlement)
// ═══════════════════════════════════════════════════════════
 ...
 */
export function buildSimpleMigration(params: SimpleMigrationParams): SettlementResult {
 ...
 */
export function buildCollateralSwap(params: CollateralSwapParams): SettlementResult {
  const mode = params.mode ?? 2
  const lender = params.lender ?? 0
  ...
  return { orderData, executionData, fillerCalldata, merkleRoot: root }
}
 ...
 */
export function buildDebtSwap(params: DebtSwapParams): SettlementResult {
  const mode = params.mode ?? 2
  const lender = params.lender ?? 0
 ...
 */
export function buildClosePosition(params: ClosePositionParams): SettlementResult {
  const mode = params.mode ?? 2
  const lender = params.lender ?? 0
 ...
 */
export function buildCrossProtocolMigration(params: CrossProtocolMigrationParams): SettlementResult {
  const mode = params.mode ?? 2
