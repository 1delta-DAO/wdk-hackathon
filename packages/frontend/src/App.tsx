...
export default function App() {
  ...
  const handleSubmitOrder = useCallback(() => {
    ...
    submitOrder({ merkleRoot, settlementData: encodedSettlementData, orderData, leaves: allLeaves, signedPermissions })
  }, [merkleRoot, orderData, encodedSettlementData, allLeaves, signedPermissions, submitOrder])
