...
import { Star, Moon, Zap, Sunset, CloudLightning, Eye, Hexagon, Circle, Activity, Crosshair } from 'react-feather'
...
const THEMES: ThemeDef[] = [
  { id: 'usdt007',   label: 'USDT007',    icon: Crosshair,      custom: true },
